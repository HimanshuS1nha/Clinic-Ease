...
const ContactUs = () => {
  return (
    <section
      id="contact"
      className="flex flex-col lg:flex-row justify-center items-center gap-y-16 lg:gap-y-0  gap-x-0lg:gap-x-16 mt-20"
    >
      <div className="flex flex-col gap-y-7 w-[90%] md:w-[75%] lg:w-[50%]">
      ...
      <div className="p-5 bg-emerald-600 flex flex-col gap-y-7 w-[90%] md:w-[75%] lg:w-[30%] rounded-lg mt-6 shadow-xl shadow-gray-300">
